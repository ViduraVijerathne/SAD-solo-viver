...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("assests/menuIcons/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("assests/menuIcons/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("assests/menuIcons/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("assests/menuIcons/light.svg"));
        }
    }
